...
import { BMLBrowser, BMLBrowserFontFace, EPG, InputApplication, InputCancelReason, inputCharacters, InputCharacterType, IP } from "./bml_browser";
...
class OverlayInputApplication implements InputApplication {
    ...
    public launch(characterType: InputCharacterType, allowedCharacters: string | undefined, maxLength: number, value: string, inputMode: "text" | "password", callback: (value: string) => void): void {
